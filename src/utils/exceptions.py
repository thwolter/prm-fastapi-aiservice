...
class ValidationException(BaseServiceException):
    ...
    def __init__(
        ...
        """
        super().__init__(
            status_code=422, detail=detail, headers=headers, error_code='VALIDATION_ERROR'
        )
        self.errors = errors
...
class RequestException(BaseServiceException):
    ...
    def __init__(
        ...
        """
        super().__init__(
            status_code=400, detail=detail, headers=headers, error_code='INVALID_REQUEST'
        )
...
class AuthenticationException(BaseServiceException):
    ...
    def __init__(
        ...
        """
        super().__init__(
            status_code=401, detail=detail, headers=headers, error_code='AUTHENTICATION_ERROR'
        )
...
class AuthorizationException(BaseServiceException):
    ...
    def __init__(
        ...
        """
        super().__init__(
            status_code=403, detail=detail, headers=headers, error_code='AUTHORIZATION_ERROR'
        )
...
class RateLimitException(BaseServiceException):
    ...
    def __init__(
        ...
        super().__init__(
            status_code=429, detail=detail, headers=headers, error_code='RATE_LIMIT_EXCEEDED'
        )
...
class QuotaExceededException(BaseServiceException):
    ...
    def __init__(
        ...
        """
        super().__init__(
            status_code=402, detail=detail, headers=headers, error_code='QUOTA_EXCEEDED'
        )
...
class InternalServerException(BaseServiceException):
    ...
    def __init__(
        ...
        """
        super().__init__(
            status_code=500, detail=detail, headers=headers, error_code='INTERNAL_SERVER_ERROR'
        )
